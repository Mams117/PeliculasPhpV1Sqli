        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form method="post" action="./controlador/insertarPelicula.php">
                        <input type="hidden" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                            name="idUser" value="<?php echo $idUser2 ?>">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" placeholder="" id="floatingTextarea2" style="height: 100px"
                                name="descripcionPelicula"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label mb-2">Seleccione los Generos de la
                                pelicula</label>
                        ...
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Seleccione los Idiomas de la
                                pelicula</label>
