...
if ($inicio == true) {
    ...
    $mysql->conectar();
    $id = $_GET['id'];
    $consulta = $mysql->efectuarConsulta("SELECT peliculas.generos.genero FROM peliculas.generos WHERE idGenero=" . $id);
    $mysql->desconectar();
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="card" style="width: 100%;">
                        <div class="card-body" style="text-align: center;">
                            <form method="post" action="controlador/editarGenero.php">
                                <input type="hidden" class="form-control" id="id" aria-describedby="emailHelp" name="id"
                                    value="<?php echo $id ?>">
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="genero" style="text-align: center;"
                                        aria-describedby="emailHelp" name="genero" value="<?php echo $genero ?>">
                                    <div id="emailHelp" class="form-text">Cambia el nombre del genero
                                    </div>
                                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="controlador/insertarGenero.php">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Genero</label>
                                    <input type="text" class="form-control" id="genero" aria-describedby="emailHelp"
                                        name="genero">
                                    <div id="emailHelp" class="form-text">Escribe el genero que quieres agregar</div>
                                </div>
