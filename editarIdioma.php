...
if ($inicio == true) {
    ...
    $mysql->conectar();
    $id = $_GET['id'];
    $consulta = $mysql->efectuarConsulta("SELECT peliculas.idiomas.idioma FROM peliculas.idiomas WHERE idIdioma=" . $id);
    $mysql->desconectar();
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="card" style="width: 100%;">
                        <div class="card-body" style="text-align: center;">
                            <form method="post" action="controlador/editarIdioma.php">
                                <input type="hidden" class="form-control" id="id" aria-describedby="emailHelp" name="id"
                                    value="<?php echo $id ?>">
                                <div class="mb-3">
                                    <input type="text" class="form-control" id="idioma" style="text-align: center;"
                                        aria-describedby="emailHelp" name="idioma" value="<?php echo $idioma ?>">
                                    <div id="emailHelp" class="form-text">Cambia el Idioma
                                    </div>
                                </div>
