<?php
if (isset($_POST['genero']) && !empty($_POST['genero']) && isset($_POST['id']) && !empty($_POST['id'])) {
    ...
    $consulta = $mysql->efectuarConsulta("UPDATE peliculas.generos SET peliculas.generos.genero='" . $genero . "' WHERE peliculas.generos.idGenero =" . $id);
    ...
    $_SESSION['mensaje'] = "Genero Actualizado Correctamente";
} else {
    header("Location: ../editarGenero.php");
    session_start();
