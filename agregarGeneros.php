                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_array($consulta)) { ?>
                                <h1>
                                    <tr>
                                        <th scope="row">
                                            <?php echo $row['idGenero'] ?>
                                        </th>
                                        <td>
                                            <?php echo $row['genero'] ?>
                                        </td>
                                        <td>
                                            <a href="./controlador/eliminarGenero.php?id= <?php echo $row['idGenero'] ?>"><i
                                                    class="fa fa-trash"></i></a>
                                        </td>
                                        <td>
                                            <a href="./editarGenero.php?id=<?php echo $row['idGenero'] ?>"><i class="bi bi-pencil-fill"></i> </a>
                                        </td>
                                    </tr>
                                </h1>
                            <?php } ?>
