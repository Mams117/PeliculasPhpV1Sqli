...
$mysql = new MySql;
$mysql->conectar();
$consulta = $mysql->efectuarConsulta("SELECT peliculas.idiomas.idIdioma, peliculas.idiomas.idioma FROM peliculas.idiomas");
$mysql->desconectar();
////////////////////////////
            ...
            <?php
                if (isset($_SESSION['error'])) {
                    ...
                    <script>
                        ...
                        let titulo = '<?php echo $_SESSION['errorTitu'] ?>'
                        Swal.fire({
                            icon: 'error',
                            title: titulo,
                            text: msj
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    style="margin-left: 15px; margin-bottom: 10px; margin-top: 50px;" data-bs-toggle="modal"
                    data-bs-target="#staticBackdrop"><i class="fa fa-plus-circle" data-bs-toggle="modal"
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_array($consulta)) { ?>
                                <h1>
                                    <tr>
                                        <th scope="row">
                                            <?php echo $row['idIdioma'] ?>
                                        </th>
                                        <td>
                                            <?php echo $row['idioma'] ?>
                                        </td>
                                        <td>
                                            <a href="./controlador/eliminarIdioma.php?id= <?php echo $row['idIdioma'] ?>"><i
                                                    class="fa fa-trash"></i></a>
                                        </td>
                                        <td>
                                            <a href="./editarIdioma.php?id=<?php echo $row['idIdioma'] ?>"> <i class="bi bi-highlighter"></i> </a>
                                        </td>
                                    </tr>
                                </h1>
                            <?php } ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Agregar Idioma</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="./controlador/insertarIdioma.php">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Idioma</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                    name="idioma">
                                <div id="emailHelp" class="form-text">Escribe el idioma que quieres agregar</div>
                            </div>
